...
//		reponseStr.setCurrPage(4);
	...
	public void updateUserInfo(@PathVariable int id,
			...
			@PathVariable String zipCode, @PathVariable String phoneno,
			@PathVariable String email, @PathVariable String tagNo,
			@PathVariable String bedId) throws UnknownHostException {
